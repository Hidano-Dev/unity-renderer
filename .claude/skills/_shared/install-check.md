...
5. `deno run -A npm:@hidano/artgraph/cli --version`
...
```
npm install -D @hidano/artgraph
pnpm add -D @hidano/artgraph
bun add -d @hidano/artgraph
deno add npm:@hidano/artgraph
```
