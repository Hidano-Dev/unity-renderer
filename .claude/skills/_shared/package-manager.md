...
| --- | --- | --- |
| npm | `npm install -D @hidano/artgraph` | `npx artgraph <cmd>` |
| pnpm | `pnpm add -D @hidano/artgraph` | `pnpm exec artgraph <cmd>` |
| bun | `bun add -d @hidano/artgraph` | `bunx artgraph <cmd>` |
| deno | `deno add npm:@hidano/artgraph` | `deno run -A npm:@hidano/artgraph/cli <cmd>` |
