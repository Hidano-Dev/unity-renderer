...
| --- | --- | --- | --- |
| npm | `npm install -D @hidano/artgraph` | `npx artgraph init --agents=<agents>` | `npx artgraph check` |
| pnpm | `pnpm add -D @hidano/artgraph` | `pnpm exec artgraph init --agents=<agents>` | `pnpm exec artgraph check` |
| bun | `bun add -d @hidano/artgraph` | `bunx artgraph init --agents=<agents>` | `bunx artgraph check` |
| deno | `deno add npm:@hidano/artgraph` | `deno run -A npm:@hidano/artgraph/cli init --agents=<agents>` | `deno run -A npm:@hidano/artgraph/cli check` |
